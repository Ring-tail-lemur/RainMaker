// const Chart = import('chart.js/auto').default;
import Chart from 'chart.js/auto';
// const Chart = require('chart.js/auto').default;
// const getDoraApi = require('../api/getDoraApiByAxios');
// const getDoraMetricsbyAxios = import('../api/getDoraApiByAxios');
import getDoraMetricsbyAxios from '../api/getDoraApiByAxios';
...
async function chartChange(start_time, end_time, repo){
    ...
    let returnVal1 = await getDoraMetricsbyAxios(start_time, end_time, repo, url + '/dorametric/lead-time-for-change');
    ...
    let returnVal2 = await getDoraMetricsbyAxios(start_time, end_time, repo, url + '/dorametric/deployment-frequency');
    ...
    let returnVal3 = await getDoraMetricsbyAxios(start_time, end_time, repo, url + '/dorametric/change-failure-rate');
    ...
    let returnVal4 = await getDoraMetricsbyAxios(start_time, end_time, repo, url + '/dorametric/time-to-restore-service');
