...
ALTER TABLE issue
    ADD CONSTRAINT FK_issue_label_TO_issue_1 FOREIGN KEY (issue_label_id)
        REFERENCES issue_label (issue_label_id);
...
ALTER TABLE branch
    ADD CONSTRAINT UNIQUE_name_AND_repository_id_TO_branch_1 UNIQUE ([name], repository_id);

ALTER TABLE failed_change
    ADD CONSTRAINT UNIQUE_release_id_AND_repository_id_TO_failed_change_1 UNIQUE (release_id, repository_id);

ALTER TABLE pull_request_commit_table
    ADD CONSTRAINT UNIQUE_pull_request_id_commit_id_TO_pull_request_commit_table_1 UNIQUE (pull_request_id, commit_id);
