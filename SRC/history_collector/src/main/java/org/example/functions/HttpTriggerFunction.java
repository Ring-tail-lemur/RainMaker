...
public class HttpTriggerFunction {
  ...
  public HttpResponseMessage run(
    ...
    ApiGeneratorFactory apiGeneratorFactory = new ApiGeneratorFactory(
      request.getQueryParameters()
    );
    List<HttpRequestDto> httpRequestDtoList = apiGeneratorFactory.getAllHttpRequestDtoList(
      jsonObjectConfig
    );
    Map<String, JSONArray> responseJSONArrayList = httpRequestSender.sendAllHttpRequest(
      httpRequestDtoList
    );
