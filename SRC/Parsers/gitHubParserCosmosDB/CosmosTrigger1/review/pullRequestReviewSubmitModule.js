...
async function pullRequestSubmitModule(pool, eventObject, context){
    ...
    await pullRequestReviewCreateRepository.insertPullRequestCommentByPullRequestIdAndUserId(pool, context, eventObject.review_id, eventObject.event_time, eventObject.pull_request_remote_identifier, eventObject.actor_remote_id, eventObject.review_state);
}
