...
async function pullRequestOpenMain(eventObject, context) {
    ...
    await pullRequestCreateRepository.insertPullRequestEventOpenByPullRequestIdAndUserId(eventObject.action, eventObject.pull_request_open_time, pullRequest_id, eventObject.pull_request_user_id);
