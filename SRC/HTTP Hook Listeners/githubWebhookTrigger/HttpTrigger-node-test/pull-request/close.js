...
module.exports ={
    async pullRequestClose(hookBody, cloudEventObj){
        ...
        await commit_module.commitMain(commits_url,cloudEventObj.private, cloudEventObj.pull_request_remote_identifier);
