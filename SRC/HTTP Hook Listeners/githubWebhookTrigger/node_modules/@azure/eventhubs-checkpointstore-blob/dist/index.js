 ...
 */
const logger = logger$1.createClientLogger("eventhubs-checkpointstore-blob");
/**
...
class BlobCheckpointStore {
    ...
    listOwnership(fullyQualifiedNamespace, eventHubName, consumerGroup) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    for (var blobs_1 = tslib.__asyncValues(blobs), blobs_1_1; blobs_1_1 = yield blobs_1.next(), !blobs_1_1.done;) {
    ...
    listCheckpoints(fullyQualifiedNamespace, eventHubName, consumerGroup) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const checkpoints = [];
            try {
                for (var blobs_2 = tslib.__asyncValues(blobs), blobs_2_1; blobs_2_1 = yield blobs_2.next(), !blobs_2_1.done;) {
 ...
 * @internal
 */
function parseIntOrThrow(blobName, fieldName, numStr) {
    if (numStr == null) {
...
exports.BlobCheckpointStore = BlobCheckpointStore;
