...
public class OlapQuery {
	public static final String MAKE_LEAD_TIME_FOR_CHANGE = "BEGIN TRAN\n"
		...
		+ "COMMIT TRAN\n"
		+ "\n";
	public static final String MAKE_DEPLOY_TIME = "WITH target_release AS (SELECT release.release_id\n"
		+ "                        FROM release\n"
		...
		+ "SET lead_time_for_change_process_end = 1\n"
		+ "where lead_time_for_change_process_end = 0";
	public static final String MAKE_CHANGE_FAILURE_RATE = "INSERT INTO failed_change (release_id, first_error_issue_id, repository_id, failed_at)\n"
